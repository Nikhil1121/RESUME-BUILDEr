...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    
    {
      ...
      description: "Elegant and traditional resume layout."
    },
    {
      id: "modern",
      name: "Modern Template",
      preview: "/templates/modern-preview.png",
      description: "Bold, modern design with accent color sections."
    },
    {
      id: "minimal",
      name: "Minimal Template",
      preview: "/templates/minimal-preview.png",
      description: "Simple, clean, and professional look."
    },
    {
      id: "minimalImage",
      name: "Minimal Image Template",
      preview: "/templates/minimalimage-preview.png",
      description: "Professional layout with right-side image."
    },
